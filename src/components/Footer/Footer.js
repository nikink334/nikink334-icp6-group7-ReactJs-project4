...
function Footer() {
    ...
    <div className="footer">
        ...
        <div id="contactID">
            <p className='mainHead'> <b> Social Media </b> </p>
            <ul className="linkFooter">
                <li> 
        ...
        <div>
            <p className='mainHead'> <b> Contact </b> </p>
            <ul className="linkFooter">
